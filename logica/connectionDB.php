...
if(isset($_POST['connectBTN'])){
	...
	if($_POST['host'] != "" && $_POST['port'] != "" && $_POST['db'] != "" && $_POST['user'] != "" &&$_POST['password'] != ""){
		...
		$conjunto = $_SESSION['connect']->consultAmount();
		Arquivo::salvarCSV("../dados/streamgraph.csv", $conjunto);

		$conjunto = $_SESSION['connect']->consultAmountIssues($_SESSION['currentVersion']);
		Arquivo::salvarCSV("../dados/streamgraphIssues.csv", $conjunto);
