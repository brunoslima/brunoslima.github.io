  ...
  <body>
    ...
    <section class="conteudo">
      <div class="conteudo-about">
        ...
        <p id="p-about">TDCodeVis is a visualization tool used as support for the monitoring and management techniques debt source code.</p>
        <p id="p-about">The data used by TDCodeVis comes from a database of the technical debt catalog provided by the TD-Tracker tool. TDCodeVis integrates with the TD-Tracker database to provide the application of visualization techniques in the source code technical debt catalog.</p>
        ...
        <p id="p-about">An example of the database used by TDCodeVis can be found at: <a href="https://github.com/brunoslima/Catalogo-Dividas-Tecnicas">GitHub - technical debt catalog</a>. For more information contact us by email: bruno.s.lima@unesp.br</p>
      </div>
    </section>
